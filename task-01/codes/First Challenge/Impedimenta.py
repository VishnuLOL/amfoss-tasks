...
try:
    ...
    print(f'''{userName} (@{userLogin}), you are about to use the {spell} spell. Are you sure this is the right one?If yes, then the secret code assosciated with it is:{code}''')
